...
public class GradeApp1 {
	...
	public static void main(String[] args) {
		...
		String lg = Grade.getLetterGrade1(marks);    // in the model package we have a Grade class which has a method called getLetterGrade that takes the input of the user and change it into the letter.
